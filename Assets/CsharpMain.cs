...
namespace zfooscharp
{
    ...
    public class CsharpMain : MonoBehaviour
    {
        ...
        public static OnMessage _message;
        public static OnOpen _open;
        public static OnNetClose _close;
        public static OnNetError _error;
        ...
        private async void Start()
        {
            ...
            // 委托绑定消息接受器
            _open += () => Debug.Log("open connection");
