...
namespace zfoo
{
    public abstract class AbstractClient
    {
        ...
        protected void ReceiveLoop()
        {
            ...
            var messageQueueLastWarningTimestamp = DateTime.UtcNow;
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    {
                        var elapsed = DateTime.UtcNow - messageQueueLastWarningTimestamp;
                        if (elapsed.TotalSeconds > 10)
                        {
                            ...
                            messageQueueLastWarningTimestamp = DateTime.UtcNow;
                        }
                    }
                }
            }
            catch (SocketException exception)
            {
                ...
                Debug.LogError("Client Recv: failed to connect to " +  ToConnectUrl() + " reason="+exception.ToString());
